 ...
 - [[[Demuth]]] Demuth Axel, _Bâtiments lod-2 et kinetic_, link:[Universite De Strasbourg - Ufr Math-Info], xref:attachment$Demuth-Axel-Antora[https://deploy-preview-24--ktirio-geom-docs.netlify.app/internship-reports-2024/building_lod2/],  xref:attachment$Demuth-Axel-slides.pdf[Demuth-Axel-slides.pdf] 
