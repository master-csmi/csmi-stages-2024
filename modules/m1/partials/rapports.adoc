 ...
 - [[[Demuth]]] Demuth Axel, _Bâtiments lod-2 et kinetic_, link:[Universite De Strasbourg - Ufr Math-Info], xref:attachment$Demuth-Axel-Antora[https://deploy-preview-24--ktirio-geom-docs.netlify.app],  xref:attachment$Demuth-Axel-slides.pdf[Demuth-Axel-slides.pdf] 
